...
//
// File: motion_controller_acc_and_brk.h
//
...
//
#ifndef RTW_HEADER_motion_controller_acc_and_brk_h_
#define RTW_HEADER_motion_controller_acc_and_brk_h_
#include "rtwtypes.h"
...
#define motion_controller_acc_and_brk_M (motion_controller_acc_and_br_M)
...
struct B_motion_controller_acc_and_b_T {
...
struct DW_motion_controller_acc_and__T {
  ros_slros2_internal_block_Get_T obj; // '<S2>/Get Parameter5'
  ros_slros2_internal_block_Get_T obj_e;// '<S2>/Get Parameter4'
  ros_slros2_internal_block_Get_T obj_g;// '<S2>/Get Parameter3'
  ros_slros2_internal_block_Get_T obj_l;// '<S2>/Get Parameter2'
  ros_slros2_internal_block_Get_T obj_n;// '<S2>/Get Parameter1'
  ros_slros2_internal_block_Get_T obj_l0;// '<S2>/Get Parameter'
...
struct P_motion_controller_acc_and_b_T_ {
...
struct tag_RTM_motion_controller_acc_T {
  const char_T * volatile errorStatus;
};

// Class declaration for model motion_controller_acc_and_brk
class motion_controller_acc_and_brk
{
  // public data and function members
 public:
  // Real-Time Model get method
  RT_MODEL_motion_controller_ac_T * getRTM();
 ...
 private:
  // Block signals
  B_motion_controller_acc_and_b_T motion_controller_acc_and_brk_B;

  // Block states
  DW_motion_controller_acc_and__T motion_controller_acc_and_br_DW;

  // Tunable parameters
  static P_motion_controller_acc_and_b_T motion_controller_acc_and_brk_P;
  ...
  static void motion_control_CurrentTime_Init(DW_CurrentTime_motion_control_T
    *localDW);
  void motion_controller_a_CurrentTime(B_CurrentTime_motion_controll_T *localB);
  ...
  void motion_contr_SystemCore_setup_k(ros_slros2_internal_block_Pub_T *obj);
  void motion_cont_SystemCore_setup_kd(ros_slros2_internal_block_Sub_T *obj);

  // Real-Time Model
  RT_MODEL_motion_controller_ac_T motion_controller_acc_and_br_M;
};
...
//
//  '<Root>' : 'motion_controller_acc_and_brk'
//  '<S1>'   : 'motion_controller_acc_and_brk/cmd_pub'
//  '<S2>'   : 'motion_controller_acc_and_brk/controller'
//  '<S3>'   : 'motion_controller_acc_and_brk/ctc'
//  '<S4>'   : 'motion_controller_acc_and_brk/subscription'
//  '<S5>'   : 'motion_controller_acc_and_brk/cmd_pub/Blank Message1'
//  '<S6>'   : 'motion_controller_acc_and_brk/cmd_pub/Blank Message2'
//  '<S7>'   : 'motion_controller_acc_and_brk/cmd_pub/For Each Subsystem'
//  '<S8>'   : 'motion_controller_acc_and_brk/cmd_pub/For Each Subsystem1'
//  '<S9>'   : 'motion_controller_acc_and_brk/cmd_pub/Publish'
//  '<S10>'  : 'motion_controller_acc_and_brk/cmd_pub/Publish2'
//  '<S11>'  : 'motion_controller_acc_and_brk/cmd_pub/For Each Subsystem/Blank Message4'
//  '<S12>'  : 'motion_controller_acc_and_brk/cmd_pub/For Each Subsystem1/Blank Message4'
//  '<S13>'  : 'motion_controller_acc_and_brk/controller/Chart'
//  '<S14>'  : 'motion_controller_acc_and_brk/subscription/Subscribe'
//  '<S15>'  : 'motion_controller_acc_and_brk/subscription/display'
//  '<S16>'  : 'motion_controller_acc_and_brk/subscription/Subscribe/Enabled Subsystem'

#endif                           // RTW_HEADER_motion_controller_acc_and_brk_h_
