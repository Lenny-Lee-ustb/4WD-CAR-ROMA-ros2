...
//
#ifndef RTW_HEADER_agent5000_types_h_
#define RTW_HEADER_agent5000_types_h_
#include "rtwtypes.h"
...
#ifndef struct_dlarray_1_agent5000_T
#define struct_dlarray_1_agent5000_T

struct dlarray_1_agent5000_T
{
  real32_T Data[2];
};

#endif                                 // struct_dlarray_1_agent5000_T

#ifndef struct_cell_wrap_2_agent5000_T
#define struct_cell_wrap_2_agent5000_T

struct cell_wrap_2_agent5000_T
{
  real_T f1[2];
};

#endif                                 // struct_cell_wrap_2_agent5000_T
...
{
  cell_wrap_2_agent5000_T UpperLimits_;
  cell_wrap_2_agent5000_T LowerLimits_;
};
...
typedef struct P_CoreSubsys_agent5000_g_T_ P_CoreSubsys_agent5000_g_T;

// Parameters for system: '<S12>/For Each Subsystem1'
typedef struct P_CoreSubsys_agent5000_gm_T_ P_CoreSubsys_agent5000_gm_T;

// Parameters (default storage)
typedef struct P_agent5000_T_ P_agent5000_T;

// Forward declaration for rtModel
typedef struct tag_RTM_agent5000_T RT_MODEL_agent5000_T;

#endif                                 // RTW_HEADER_agent5000_types_h_
