...
// C/C++ source code generated on : Tue Apr 22 13:56:18 2025
//
#ifdef _MSC_VER
#pragma warning(push)
...
#include <chrono>
#include <utility>
const std::string SLROSNodeName("agent5000");
