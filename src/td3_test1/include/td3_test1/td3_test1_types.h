...
//
#ifndef RTW_HEADER_td3_test1_types_h_
#define RTW_HEADER_td3_test1_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLABSystem: '<S30>/SourceBlock'
...
// Custom Type definition for MATLAB Function: '<S28>/PolicyWrapper'
#ifndef struct_dlarray_1_td3_test1_T
#define struct_dlarray_1_td3_test1_T

struct dlarray_1_td3_test1_T
{
  real32_T Data[2];
};

#endif                                 // struct_dlarray_1_td3_test1_T

#ifndef struct_cell_wrap_2_td3_test1_T
#define struct_cell_wrap_2_td3_test1_T

struct cell_wrap_2_td3_test1_T
{
  real_T f1[2];
};

#endif                                 // struct_cell_wrap_2_td3_test1_T
...
{
  cell_wrap_2_td3_test1_T UpperLimits_;
  cell_wrap_2_td3_test1_T LowerLimits_;
};
...
typedef struct P_CoreSubsys_td3_test1_g_T_ P_CoreSubsys_td3_test1_g_T;

// Parameters for system: '<S4>/For Each Subsystem1'
typedef struct P_CoreSubsys_td3_test1_gm_T_ P_CoreSubsys_td3_test1_gm_T;

// Parameters (default storage)
typedef struct P_td3_test1_T_ P_td3_test1_T;

// Forward declaration for rtModel
typedef struct tag_RTM_td3_test1_T RT_MODEL_td3_test1_T;

#endif                                 // RTW_HEADER_td3_test1_types_h_
