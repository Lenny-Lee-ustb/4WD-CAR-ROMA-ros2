...
//
#ifndef RTW_HEADER_agent1_h_
#define RTW_HEADER_agent1_h_
#include "rtwtypes.h"
...
struct B_agent1_T {
  ...
  cell_wrap_2_agent1_T b;
  cell_wrap_2_agent1_T c;
  dlarray_1_agent1_T dlArrayOutputs;
  ...
  B_CurrentTime_agent1_T CurrentTime1; // '<S12>/Current Time'
  B_CurrentTime_agent1_T CurrentTime;  // '<S12>/Current Time'
};
...
struct DW_agent1_T {
  ...
  uint8_T is_active_c6_agent1;         // '<S44>/Chart2'
  uint8_T is_active_c3_agent1;         // '<S13>/Chart'
  uint8_T is_Is_ready;                 // '<S13>/Chart'
  uint8_T is_cmd;                      // '<S13>/Chart'
  uint8_T is_qtest;                    // '<S13>/Chart'
  uint8_T is_active_c7_agent1;         // '<S8>/Chart'
  uint8_T is_c7_agent1;                // '<S8>/Chart'
  uint8_T is_active_c18_agent1;        // '<Root>/Chart'
  uint8_T is_c18_agent1;               // '<Root>/Chart'
  ...
  DW_CurrentTime_agent1_T CurrentTime1;// '<S12>/Current Time'
  DW_CurrentTime_agent1_T CurrentTime; // '<S12>/Current Time'
};

// Parameters for system: '<S12>/For Each Subsystem'
struct P_CoreSubsys_agent1_g_T_ {
...
struct P_CoreSubsys_agent1_gm_T_ {
  SL_Bus_custom_interfaces_Actuator Constant_Value;// Computed Parameter: Constant_Value
...
struct P_agent1_T_ {
  ...
  P_CoreSubsys_agent1_gm_T CoreSubsys_pn;// '<S12>/For Each Subsystem1'
  P_CoreSubsys_agent1_g_T CoreSubsys_p;// '<S12>/For Each Subsystem'
};

// Real-time Model Data Structure
struct tag_RTM_agent1_T {
  const char_T * volatile errorStatus;
};

// Class declaration for model agent1
class agent1
{
  // public data and function members
 public:
  // Real-Time Model get method
  RT_MODEL_agent1_T * getRTM();
 ...
 private:
  ...
  // Block states
  DW_agent1_T agent1_DW;

  // Tunable parameters
  static P_agent1_T agent1_P;

  // private member function(s) for subsystem '<S12>/Current Time'
  static void agent1_CurrentTime_Init(DW_CurrentTime_agent1_T *localDW);
  void agent1_CurrentTime(B_CurrentTime_agent1_T *localB);
  static void agent1_CurrentTime_Term(DW_CurrentTime_agent1_T *localDW);

  // private member function(s) for subsystem '<S13>/get_angle_4w'
  void agent1_get_angle_4w(real_T rtu_delta_f, real_T rtu_delta_r, real_T
    rty_angle_cmd[4]) const;

  // private member function(s) for subsystem '<S13>/get_effort'
  void agent1_get_effort_Init();
  void agent1_get_effort();
  void agent1_get_effort_Term();

  // private member function(s) for subsystem '<S13>/get_spd'
  void agent1_get_spd_Init();
  void agent1_get_spd(real_T rtu_angle, real_T rtu_longdrive, real_T
                      rty_spd_cmd[4]);
  void agent1_get_spd_Term();

  // private member function(s) for subsystem '<Root>'
  void agent1_microKernel11(int32_T K, real32_T *A, int32_T LDA, const real32_T *
    B, int32_T LDB, real32_T *C, int32_T LDC);
  void agent1_macroKernel1(int32_T M, int32_T K, int32_T N, const real32_T *A,
    int32_T LDA, const real32_T *B, int32_T LDB, real32_T *C, int32_T LDC);
  void agent1_matrixMultiply1(int32_T M, int32_T K, int32_T N, int32_T
  ...
  void agent1_elementwise_relu(const real32_T *inputTensor, real32_T
    *outputTensor, int32_T numElements);
  void agent1_unaryElementwise(real32_T X[256], real32_T Z[256]);
  void FullyConnectedLayer_predict_gl(real32_T layer_Weights[512], const
    real32_T layer_Bias[2], real32_T X[256], real32_T Z[2]);
  void agent1_dlnetwork_predict(c_coder_internal_ctarget_dlne_T *obj, const
    real32_T varargin_1_Data[15], real32_T varargout_1_Data[2]);
  void agent1_SystemCore_setup_di5xwl(ros_slros2_internal_block_Pub_T *obj);
  void agent1_SystemCore_setup_di5xwlx(ros_slros2_internal_block_Pub_T *obj);
  void agent1_SystemCore_setup_di5(ros_slros2_internal_block_Sub_T *obj);
  void agent1_SystemCore_setup_di5x(ros_slros2_internal_block_Sub_T *obj);
  void agent_SystemCore_setup_di5xwlxz(ros_slros2_internal_block_Sub_T *obj);
  void agent1_SystemCore_setup(ros_slros2_internal_block_Pub_T *obj);
  void agent1_SystemCore_setup_d(ros_slros2_internal_block_Pub_T *obj);
  void agent1_SystemCore_setup_di(ros_slros2_internal_block_Pub_T *obj);
  void agen_SystemCore_setup_di5xwlxz2(ros_slros2_internal_block_Sub_T *obj);
  void agent1_SystemCore_setup_di5xw(ros_slros2_internal_block_Sub_T *obj);

  // Real-Time Model
  RT_MODEL_agent1_T agent1_M;
};
...
//  '<Root>' : 'agent1'
//  '<S1>'   : 'agent1/Chart'
//  '<S2>'   : 'agent1/Compare To Constant'
//  '<S3>'   : 'agent1/MATLAB Function1'
//  '<S4>'   : 'agent1/MATLAB Function2'
//  '<S5>'   : 'agent1/StateFlow'
//  '<S6>'   : 'agent1/StateFlow1'
//  '<S7>'   : 'agent1/StateFlow5'
//  '<S8>'   : 'agent1/Subsystem1'
//  '<S9>'   : 'agent1/Subsystem2'
//  '<S10>'  : 'agent1/Subsystem3'
//  '<S11>'  : 'agent1/Subsystem5'
//  '<S12>'  : 'agent1/cmd_pub'
//  '<S13>'  : 'agent1/controller'
//  '<S14>'  : 'agent1/controller1'
//  '<S15>'  : 'agent1/subscription'
//  '<S16>'  : 'agent1/StateFlow/Blank Message1'
//  '<S17>'  : 'agent1/StateFlow/Publish2'
//  '<S18>'  : 'agent1/StateFlow1/Blank Message1'
//  '<S19>'  : 'agent1/StateFlow1/Publish2'
//  '<S20>'  : 'agent1/StateFlow5/Blank Message1'
//  '<S21>'  : 'agent1/StateFlow5/Publish2'
//  '<S22>'  : 'agent1/Subsystem1/Chart'
//  '<S23>'  : 'agent1/Subsystem1/For Each Subsystem'
//  '<S24>'  : 'agent1/Subsystem1/MATLAB Function'
//  '<S25>'  : 'agent1/Subsystem1/MATLAB Function1'
//  '<S26>'  : 'agent1/Subsystem1/MATLAB Function2'
//  '<S27>'  : 'agent1/Subsystem1/Subscribe'
//  '<S28>'  : 'agent1/Subsystem1/Subscribe1'
//  '<S29>'  : 'agent1/Subsystem1/Subscribe2'
//  '<S30>'  : 'agent1/Subsystem1/Subscribe/Enabled Subsystem'
//  '<S31>'  : 'agent1/Subsystem1/Subscribe1/Enabled Subsystem'
//  '<S32>'  : 'agent1/Subsystem1/Subscribe2/Enabled Subsystem'
//  '<S33>'  : 'agent1/Subsystem2/Compare To Constant'
//  '<S34>'  : 'agent1/Subsystem3/Compare To Constant1'
//  '<S35>'  : 'agent1/cmd_pub/Blank Message1'
//  '<S36>'  : 'agent1/cmd_pub/Blank Message2'
//  '<S37>'  : 'agent1/cmd_pub/For Each Subsystem'
//  '<S38>'  : 'agent1/cmd_pub/For Each Subsystem1'
//  '<S39>'  : 'agent1/cmd_pub/Publish'
//  '<S40>'  : 'agent1/cmd_pub/Publish2'
//  '<S41>'  : 'agent1/cmd_pub/For Each Subsystem/Blank Message4'
//  '<S42>'  : 'agent1/cmd_pub/For Each Subsystem1/Blank Message4'
//  '<S43>'  : 'agent1/controller/Chart'
//  '<S44>'  : 'agent1/controller/Subsystem'
//  '<S45>'  : 'agent1/controller/get_angle_4w'
//  '<S46>'  : 'agent1/controller/get_effort'
//  '<S47>'  : 'agent1/controller/get_spd'
//  '<S48>'  : 'agent1/controller/Subsystem/Chart2'
//  '<S49>'  : 'agent1/controller/Subsystem/MATLAB Function'
//  '<S50>'  : 'agent1/controller/get_angle_4w/MATLAB Function'
//  '<S51>'  : 'agent1/controller/get_effort/MATLAB Function'
//  '<S52>'  : 'agent1/controller/get_spd/MATLAB Function'
//  '<S53>'  : 'agent1/controller1/MATLAB Function'
//  '<S54>'  : 'agent1/controller1/Policy'
//  '<S55>'  : 'agent1/controller1/Policy/PolicyWrapper'
//  '<S56>'  : 'agent1/subscription/For Each Subsystem'
//  '<S57>'  : 'agent1/subscription/Subscribe'
//  '<S58>'  : 'agent1/subscription/Subscribe1'
//  '<S59>'  : 'agent1/subscription/display'
//  '<S60>'  : 'agent1/subscription/Subscribe/Enabled Subsystem'
//  '<S61>'  : 'agent1/subscription/Subscribe1/Enabled Subsystem'

#endif                                 // RTW_HEADER_agent1_h_
