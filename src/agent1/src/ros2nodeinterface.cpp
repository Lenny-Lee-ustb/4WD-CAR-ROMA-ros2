...
// C/C++ source code generated on : Mon Apr 28 16:19:44 2025
//
#ifdef _MSC_VER
#pragma warning(push)
...
#include <chrono>
#include <utility>
const std::string SLROSNodeName("agent1");
