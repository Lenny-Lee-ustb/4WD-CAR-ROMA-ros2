...
//
#ifndef RTW_HEADER_agent2_types_h_
#define RTW_HEADER_agent2_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLAB Function: '<S51>/PolicyWrapper'
#ifndef struct_dlarray_1_agent2_T
#define struct_dlarray_1_agent2_T

struct dlarray_1_agent2_T
{
  real32_T Data[2];
};

#endif                                 // struct_dlarray_1_agent2_T

#ifndef struct_cell_wrap_2_agent2_T
#define struct_cell_wrap_2_agent2_T

struct cell_wrap_2_agent2_T
{
  real_T f1[2];
};

#endif                                 // struct_cell_wrap_2_agent2_T
...
{
  cell_wrap_2_agent2_T UpperLimits_;
  cell_wrap_2_agent2_T LowerLimits_;
};
...
typedef struct P_CoreSubsys_agent2_g_T_ P_CoreSubsys_agent2_g_T;

// Parameters for system: '<S8>/For Each Subsystem1'
typedef struct P_CoreSubsys_agent2_gm_T_ P_CoreSubsys_agent2_gm_T;

// Parameters (default storage)
typedef struct P_agent2_T_ P_agent2_T;

// Forward declaration for rtModel
typedef struct tag_RTM_agent2_T RT_MODEL_agent2_T;

#endif                                 // RTW_HEADER_agent2_types_h_
