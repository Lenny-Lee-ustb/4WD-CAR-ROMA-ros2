...
//
#ifndef RTW_HEADER_motion_controller_slx_types_h_
#define RTW_HEADER_motion_controller_slx_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLABSystem: '<S32>/SourceBlock'
...
typedef struct P_motion_controller_slx_T_ P_motion_controller_slx_T;

// Forward declaration for rtModel
typedef struct tag_RTM_motion_controller_slx_T RT_MODEL_motion_controller_sl_T;

#endif                             // RTW_HEADER_motion_controller_slx_types_h_
