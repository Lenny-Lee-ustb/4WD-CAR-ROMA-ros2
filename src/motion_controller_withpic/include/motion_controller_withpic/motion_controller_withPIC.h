...
struct B_motion_controller_withPIC_T {
  ...
  real_T y_n[1200];
  real_T b_y_p[1200];
  real_T H[1200];                      // '<S62>/predict'
  real_T rtb_H_l[1200];
  real_T rtb_H_j[1200];
  real_T y_d[800];
  real_T G_e[720];                     // '<S61>/predict'
  real_T Rp_g[400];
  real_T rtb_H_ld[400];
  real_T G[360];                       // '<S62>/predict'
  SL_Bus_custom_interfaces_ActuatorState In1;// '<S72>/In1'
  SL_Bus_custom_interfaces_ActuatorState In1_j;// '<S35>/In1'
  ...
  real_T rtb_H_o[120];
  SL_Bus_nav_msgs_Odometry In1_je;     // '<S33>/In1'
  ...
  real_T vn2_l[81];
  real_T work_h[81];
  SL_Bus_custom_interfaces_Actuator ImpAsg_InsertedFor_actuaor_[4];// '<S40>/Bus Assignment1' 
  real_T T_c[80];                      // '<S61>/predict'
  real_T rtb_T_b[80];
  real_T b_b[60];
  SL_Bus_sensor_msgs_Imu In1_f;        // '<S34>/In1'
  SL_Bus_sensor_msgs_Imu BusAssignment2;// '<S6>/Bus Assignment2'
  int8_T K_d[400];
  s3PrFoa9w5ssw8XLEJooNqH_motio_T QPObjective_e;
  real_T work_b[41];
  real_T V[40];
  real_T T[40];                        // '<S62>/predict'
  real_T b_K[40];
  real_T rtb_H_e_j[40];
  ...
  real_T t_j[36];
  SL_Bus_sbus_interface_Sbus In1_m;    // '<S71>/In1'
  ...
  real_T rtb_Add_c_re_ex;
  real_T rtb_Add_c_im_fi;
  real_T rtb_Add_c_im_h2;
  real_T rtb_Add_c_re_ei;
  ...
  real_T rtb_Add_c_im_ij;
  real_T rtb_Add_c_re_my;
  ...
  real_T rtb_Add_c_im_pm;
  real_T rtb_Add_c_re_p2;
  real_T rtb_Add_c_im_nj;
  real_T rtb_Add_c_re_kt;
  ...
  real_T rtb_Add_c_im_g4;
  real_T rtb_Add_c_re_c3;
  ...
  real_T rtb_Add_c_im_h22;
  real_T rtb_Add_c_re_nm;
  ...
  real_T rtb_Add_c_im_ce;
  real_T rtb_Add_c_re_nc;
  ...
  real_T rtb_Add_c_re_a4;
  real_T rtb_Add_c_im_ow;
  real_T rtb_Add_c_re_jw;
  real_T rtb_Add_c_im_pie;
  ...
  real_T Fy3_tmp;
  real_T Fy4_tmp;
  real_T rtb_ImpAsg_InsertedFor_Out1__fc;
  ...
  real_T rtb_ImpAsg_InsertedFor_Out1__a0;
  ...
  real_T rtb_ImpAsg_InsertedFor_Out1__f1;
  real_T rtb_ImpAsg_InsertedFor_Out1_a_j;
  real_T rtb_ImpAsg_InsertedFor_Out1__ho;
  real_T rtb_ImpAsg_InsertedFor_Out1__cf;
  ...
  real_T phaseOneCorrectionP_g;
  real_T pk_corrected_o;
  real_T ratio_h;
  real_T b_c_c;
  real_T scale_a;
  real_T absxk_l;
  real_T t_jc;
  real_T denomTol_i;
  real_T phaseOneCorrectionX_m;
  real_T phaseOneCorrectionP_f;
  real_T pk_corrected_on;
  real_T ratio_i;
  real_T b_c_e;
  real_T scale_j;
  real_T absxk_o;
  ...
  int32_T kend;
  int32_T k_b;
  int32_T idxFillStart_j;
  int32_T colOffsetATw_e;
  int32_T e_i;
  int32_T c_k_n;
  int32_T i_i;
  int32_T mConstr;
  ...
  int32_T jA;
  int32_T i_b;
  int32_T activeSetChangeID_a;
  int32_T nVar_i;
  int32_T localActiveConstrIdx_n;
  ...
  int32_T ijA;
  int32_T nVar_b;
  int32_T nullStartIdx_j;
  int32_T nVars_n;
  int32_T A_maxDiag_idx_f;
  int32_T b_A_maxDiag_idx_e;
  int32_T lastColC_i;
  int32_T br_a;
  int32_T ar_f;
  int32_T ic_k;
...
struct DW_motion_controller_withPIC_T {
  sSOeZ9WO10chPn9Si6PKiCB_motio_T opts;// '<S61>/solvex'
  sSOeZ9WO10chPn9Si6PKiCB_motio_T opts_j;// '<S62>/solvex'
  ...
  ros_slros2_internal_block_Get_T obj_a;// '<S48>/Get Parameter5'
  ros_slros2_internal_block_Get_T obj_lw;// '<S48>/Get Parameter3'
  ros_slros2_internal_block_Get_T obj_ae;// '<S48>/Get Parameter2'
  ros_slros2_internal_block_Get_T obj_d;// '<S48>/Get Parameter'
  ros_slros2_internal_block_Get_T obj_g;// '<S46>/Get Parameter5'
  ros_slros2_internal_block_Get_T obj_e;// '<S46>/Get Parameter4'
  ros_slros2_internal_block_Get_T obj_l4;// '<S46>/Get Parameter3'
  ros_slros2_internal_block_Get_T obj_c;// '<S46>/Get Parameter2'
  ros_slros2_internal_block_Get_T obj_o;// '<S46>/Get Parameter1'
  ros_slros2_internal_block_Get_T obj_m;// '<S46>/Get Parameter'
  ...
  ros_slros2_internal_block_Pub_T obj_ca;// '<S42>/SinkBlock'
  ros_slros2_internal_block_Pub_T obj_bq;// '<S41>/SinkBlock'
  ...
  ros_slros2_internal_block_Sub_T obj_mo;// '<S69>/SourceBlock'
  ros_slros2_internal_block_Sub_T obj_nf;// '<S68>/SourceBlock'
  ros_slros2_internal_block_Sub_T obj_dp;// '<S32>/SourceBlock'
  ros_slros2_internal_block_Sub_T obj_en;// '<S31>/SourceBlock'
  ros_slros2_internal_block_Sub_T obj_az;// '<S30>/SourceBlock'
  real_T UnitDelay_DSTATE;             // '<S16>/Unit Delay'
  real_T UnitDelay1_DSTATE;            // '<S16>/Unit Delay1'
  real_T x0[20];                       // '<S62>/solvex'
  real_T A[800];                       // '<S62>/solvex'
  real_T Umin;                         // '<S62>/solvex'
  real_T Umax;                         // '<S62>/solvex'
  real_T x0_i[40];                     // '<S61>/solvex'
  real_T A_j[3200];                    // '<S61>/solvex'
  real_T Umin_c;                       // '<S61>/solvex'
  real_T Umax_n;                       // '<S61>/solvex'
  real_T angle_out;                    // '<S46>/MATLAB Function'
  ...
  real_T data[100];                    // '<Root>/MATLAB Function2'
  ...
  uint8_T is_active_c6_motion_controller_;// '<S46>/Chart2'
  ...
  boolean_T x0_not_empty;              // '<S62>/solvex'
  boolean_T x0_not_empty_k;            // '<S61>/solvex'
  boolean_T ready;                     // '<S15>/Chart'
  boolean_T data_not_empty;            // '<Root>/MATLAB Function2'
...
struct P_motion_controller_withPIC_T_ {
  ...
  real_T DeadZone3_Start;              // Expression: -0.05
                                          //  Referenced by: '<S9>/Dead Zone3'

  real_T DeadZone3_End;                // Expression: 0.05
                                          //  Referenced by: '<S9>/Dead Zone3'
...
//  Block '<S70>/Display1' : Unused code path elimination
//  Block '<S70>/Display10' : Unused code path elimination
//  Block '<S70>/Display11' : Unused code path elimination
//  Block '<S70>/Display12' : Unused code path elimination
//  Block '<S70>/Display13' : Unused code path elimination
//  Block '<S70>/Display14' : Unused code path elimination
//  Block '<S70>/Display15' : Unused code path elimination
//  Block '<S70>/Display2' : Unused code path elimination
//  Block '<S70>/Display3' : Unused code path elimination
//  Block '<S70>/Display4' : Unused code path elimination
//  Block '<S70>/Display5' : Unused code path elimination
//  Block '<S70>/Display6' : Unused code path elimination
//  Block '<S70>/Display7' : Unused code path elimination
//  Block '<S70>/Display8' : Unused code path elimination
//  Block '<S70>/Display9' : Unused code path elimination
...
//  '<S30>'  : 'motion_controller_withPIC/Subsystem1/Subscribe'
//  '<S31>'  : 'motion_controller_withPIC/Subsystem1/Subscribe1'
//  '<S32>'  : 'motion_controller_withPIC/Subsystem1/Subscribe2'
//  '<S33>'  : 'motion_controller_withPIC/Subsystem1/Subscribe/Enabled Subsystem'
//  '<S34>'  : 'motion_controller_withPIC/Subsystem1/Subscribe1/Enabled Subsystem'
//  '<S35>'  : 'motion_controller_withPIC/Subsystem1/Subscribe2/Enabled Subsystem'
//  '<S36>'  : 'motion_controller_withPIC/Subsystem3/Compare To Constant1'
//  '<S37>'  : 'motion_controller_withPIC/cmd_pub/Blank Message1'
//  '<S38>'  : 'motion_controller_withPIC/cmd_pub/Blank Message2'
//  '<S39>'  : 'motion_controller_withPIC/cmd_pub/For Each Subsystem'
//  '<S40>'  : 'motion_controller_withPIC/cmd_pub/For Each Subsystem1'
//  '<S41>'  : 'motion_controller_withPIC/cmd_pub/Publish'
//  '<S42>'  : 'motion_controller_withPIC/cmd_pub/Publish2'
//  '<S43>'  : 'motion_controller_withPIC/cmd_pub/For Each Subsystem/Blank Message4'
//  '<S44>'  : 'motion_controller_withPIC/cmd_pub/For Each Subsystem1/Blank Message4'
//  '<S45>'  : 'motion_controller_withPIC/controller/Chart'
//  '<S46>'  : 'motion_controller_withPIC/controller/Subsystem'
//  '<S47>'  : 'motion_controller_withPIC/controller/get_angle_4w'
//  '<S48>'  : 'motion_controller_withPIC/controller/get_effort'
//  '<S49>'  : 'motion_controller_withPIC/controller/get_spd'
//  '<S50>'  : 'motion_controller_withPIC/controller/Subsystem/Chart2'
//  '<S51>'  : 'motion_controller_withPIC/controller/Subsystem/MATLAB Function'
//  '<S52>'  : 'motion_controller_withPIC/controller/get_angle_4w/MATLAB Function'
//  '<S53>'  : 'motion_controller_withPIC/controller/get_effort/MATLAB Function'
//  '<S54>'  : 'motion_controller_withPIC/controller/get_spd/MATLAB Function'
//  '<S55>'  : 'motion_controller_withPIC/picController/Compare To Constant'
//  '<S56>'  : 'motion_controller_withPIC/picController/MATLAB Function'
//  '<S57>'  : 'motion_controller_withPIC/picController/MATLAB Function2'
//  '<S58>'  : 'motion_controller_withPIC/picController/Subsystem'
//  '<S59>'  : 'motion_controller_withPIC/picController/Subsystem1'
//  '<S60>'  : 'motion_controller_withPIC/picController/update'
//  '<S61>'  : 'motion_controller_withPIC/picController/Subsystem1/If Action Subsystem'
//  '<S62>'  : 'motion_controller_withPIC/picController/Subsystem1/If Action Subsystem1'
//  '<S63>'  : 'motion_controller_withPIC/picController/Subsystem1/If Action Subsystem/predict'
//  '<S64>'  : 'motion_controller_withPIC/picController/Subsystem1/If Action Subsystem/solvex'
//  '<S65>'  : 'motion_controller_withPIC/picController/Subsystem1/If Action Subsystem1/predict'
//  '<S66>'  : 'motion_controller_withPIC/picController/Subsystem1/If Action Subsystem1/solvex'
//  '<S67>'  : 'motion_controller_withPIC/subscription/For Each Subsystem'
//  '<S68>'  : 'motion_controller_withPIC/subscription/Subscribe'
//  '<S69>'  : 'motion_controller_withPIC/subscription/Subscribe1'
//  '<S70>'  : 'motion_controller_withPIC/subscription/display'
//  '<S71>'  : 'motion_controller_withPIC/subscription/Subscribe/Enabled Subsystem'
//  '<S72>'  : 'motion_controller_withPIC/subscription/Subscribe1/Enabled Subsystem'
